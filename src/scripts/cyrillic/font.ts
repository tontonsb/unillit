...
export const cyrillicFonts: CyrillicFont[] = [
	{ id: 'lora', label: 'Serif (Lora)', family: "'Lora Variable', serif" },
	{ id: 'spectral', label: 'Serif (Spectral)', family: "'Spectral', serif" },
	{ id: 'ysabeau', label: 'Sans-serif (Ysabeau)', family: "'Ysabeau Variable', sans-serif" },
	{ id: 'ysabeau-italic', label: 'Cursive (Ysabeau)', family: "'Ysabeau Variable', sans-serif", style: 'italic' },
	{ id: 'lora-italic', label: 'Cursive (Lora)', family: "'Lora Variable', serif", style: 'italic' },
